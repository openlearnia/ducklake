...
DuckLakeVersion DuckLakeVersionFromString(const string &version_str) {
	...
	if (version_str == "1.1") {
		return DuckLakeVersion::V1_1;
	}
	if (version_str == "1.2") {
		return DuckLakeVersion::V1_2;
	}
	if (version_str == "1.3") {
		return DuckLakeVersion::V1_3;
	}
...
string DuckLakeVersionToString(DuckLakeVersion version) {
	...
	case DuckLakeVersion::V1_1_DEV_1:
		return "1.1-dev1";
	case DuckLakeVersion::V1_1:
		return "1.1";
	case DuckLakeVersion::V1_2:
		return "1.2";
	case DuckLakeVersion::V1_3:
		return "1.3";
	default:
